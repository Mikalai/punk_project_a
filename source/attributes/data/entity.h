...
//	//	/*void SetType(const Core::String& type) { m_type = type; }
...
//	//	//const Core::String& GetMaterialName() const { return m_material_name; }
//	//	//void SetMaterialName(const Core::String& name) { m_material_name = name; }
...
//	//	//void SetReferenceObjectName(const Core::String& ref) { m_reference = ref; }
//	//	//const Core::String& GetReferenceObjectName() const { return m_reference; }
//	//	//Core::String& GetReferenceObjectName() { return m_reference; }
