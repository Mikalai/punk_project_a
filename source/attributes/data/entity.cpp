//#include "entity.h"
//#include "../motions/motion_strategy.h"
...
////	Entity::~Entity()
////	{
////		for each (auto obj in m_children)
////		{
////			delete obj;
////		}
////	}
////
////	void Entity::Save(std::ostream& stream)
////	{
...
////		for each (std::shared_ptr<Entity> child in m_children)
////		{
////			child->Save(stream);
////		}
////	}
...
////		{
////			std::auto_ptr<Entity> object(new Entity);
////			object->SetParent(this);
////			object->Load(stream);
////			m_children[i] = object.release();
////		}
////	}
////
////	void Entity::BuildOctTree()
////	{
////		if (m_mesh.get())
////		{
...
////	}
////
////	bool Entity::IntersectWithRay(const Math::Vector3<float>& start, const Math::Vector3<float>& end, IntersectionCollection& res) const
////	{
...
////	}
////
////	Entity* Entity::GetChild(const System::string& name, bool deep_search)
////	{
////		return const_cast<Entity*>(static_cast<const Entity*>(this)->GetChild(name, deep_search));
////	}
////
////	const Entity* Entity::GetChild(const System::string& name, bool deep_search) const
////	{
////		for each (std::shared_ptr<Entity> obj in m_children)
////		{
////			if (obj.get() && obj->GetName() == name)
////				return obj.get();
////
////			if (deep_search && obj.get())
////			{
////				const Entity* res = obj->GetChild(name, deep_search);
////				if (res)
////				{
////					return res;
////				}
...
////	}
////
////	int Entity::GetChildIndex(const System::string& name)
////	{
////		int index = 0;
...
////
////
////	bool Entity::CookAsSkinnedMesh(Armature& armature)
////	{
////		struct Vertex
////		{
////			float x, y, z, w;
...
////		if (!m_mesh.get())
////		{
////			out_error() << L"Can't cook skinned mesh, because no mesh" << std::endl;
////			has_geom = false;
////		}
...
////		{
////			out_error() << L"Can't cook skinned mesh, because no bone weights" << std::endl;
////			has_geom = false;
////		}
////
////		if (has_geom)
////		{
////			m_skinned_mesh.reset(new SkinMesh);
////
...
////	}
////
////	void Entity::CookOneVertexWithBone(Armature& armature, int index, float& b1, float& b2, float& b3, float& b4, float& w1, float& w2, float& w3, float& w4)
////	{
...
////	}
////
////	bool Entity::IsCollisionVolume() const
////	{
...
////	}
////
////	bool Entity::TestCollision(const Math::BoundingBox& bbox) const
////	{
////		return TestCollision(bbox, m_local_matrix, *this);
////	}
////
////	bool Entity::TestCollision(const Math::BoundingBox& bbox, const Math::mat4& parent, const Entity& obj) const
////	{
////		return false;
////	}
////
////	void Entity::UpdateProxy(Entity* object)
////	{
////		if (object->IsProxy())
////		{
////			Entity* root = object;
...
////				root = root->GetParent();
////			Entity* proxy = root->GetChild(object->GetReferenceObjectName());
////			if (!proxy)
////			{
////				out_error() << L"Can't find stub for proxy object: " << object->GetReferenceObjectName() << std::endl;
////				return;
////			}
////			object->m_ref_object = proxy;
////		}
////
////		for each (auto child in object->m_children)
////		{
////			UpdateProxy(child.get());
////		}
////	}
////}
////
