...
namespace Attributes
{
	...
	/*class PUNK_ENGINE_API Proxy : public Core::IObject
	{
	public:
		Proxy();
		explicit Proxy(const Utility::WorldDesc& world_desc, const Utility::ObjectDesc& value);

		void SetData(Core::IObject* value ) { m_data = value; }
		Core::IObject* AsObject() { return m_data; }
		const Core::IObject* AsObject() const { return m_data; }		
