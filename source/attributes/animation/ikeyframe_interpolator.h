...
namespace Attributes
{
	...
	DECLARE_PUNK_GUID(CLSID_KeyFrameLinearInterpolator, "E64F443F-A5BA-4E58-9ED1-EB819E53CC7B");
	DECLARE_PUNK_GUID(CLSID_Vec3KeyFrameLinearInterpolator, "987196BC-1D7D-4F2F-90BB-75CE6C5DBF26");
	DECLARE_PUNK_GUID(CLSID_Vec4KeyFrameLinearInterpolator, "1A7F76D9-A19A-4675-9ECD-1AAF7F92F052");
	DECLARE_PUNK_GUID(CLSID_Mat4KeyFrameLinearInterpolator, "C0F2C6D3-B030-4FCD-9D40-B31E9E9B9242");
	DECLARE_PUNK_GUID(CLSID_QuatKeyFrameLinearInterpolator, "9B29CF1A-3709-4AE0-A2B2-E3CB531E17D5");
	DECLARE_PUNK_GUID(CLSID_FloatKeyFrameLinearInterpolator, "48B3B926-FB9C-4D09-9AEE-99369F53AD4D");
