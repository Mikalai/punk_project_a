...
namespace Attributes {
	...
	class VertexCountList : public IVertexCountList {
	public:
		//	IObject
		void QueryInterface(const Core::Guid& type, void** object) override {
			...
			*object = nullptr;
			...
			else if (type == IID_IVertexCountList) {
				*object = this;
				AddRef();
			}
		}
	...
	PUNK_REGISTER_CREATOR(CLSID_VertexCountList, (System::CreateInstance<VertexCountList, IVertexCountList>));
}
PUNK_ENGINE_END
