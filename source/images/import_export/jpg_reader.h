#ifndef _H_JPG_READER
#define _H_JPG_READER
...
#define INPUT_BUF_SIZE  4096	/* choose an efficiently fread'able size */
	...
	struct ReaderPolicy < ImageFileType::Jpeg > {
        ...
        static void DecodeBuffer(Core::Buffer& buffer, IImage** _image) {
			...
			jpeg_mem_src(&cinfo, (unsigned char*)buffer.Data(), (unsigned long)buffer.GetSize());
			...
			while (cinfo.output_scanline < cinfo.output_height)
			{
				...
				memcpy(dst, *source_buffer, row_stride);
				dst -= row_stride;
			}
