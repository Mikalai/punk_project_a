...
#include <attributes/data/lights/point_light.h>
#include <attributes/data/lights/spot_light.h>
#include "io_vector.h"
#include "io_object.h"
#include "io_light.h"
...
namespace Loader {
    ...
    void SaveLight(Core::Buffer* buffer, const Core::Object* object)
    {
        SaveObject(buffer, object);
    }

    void LoadLight(Core::Buffer* buffer, Core::Object* object)
    {
        LoadObject(buffer, object);
    }

    void SavePointLight(Core::Buffer *buffer, const Core::Object *o)
    {
        SaveLight(buffer, o);
    ...
    void LoadPointLight(Core::Buffer *buffer, Core::Object *o)
    {
        SaveLight(buffer, o);
    ...
    void SaveDirectionalLight(Core::Buffer *buffer, const Core::Object *o)
    {
        SaveLight(buffer, o);
    ...
    void LoadDirectionalLight(Core::Buffer *buffer, Core::Object *o)
    {
        LoadLight(buffer, o);
    ...
    void SaveSpotLight(Core::Buffer *buffer, const Core::Object *o)
    {
        SaveLight(buffer, o);
    }

    void LoadSpotLight(Core::Buffer *buffer, Core::Object *o)
    {
        LoadLight(buffer, o);
    }
}
