...
namespace LowLevelRender {
	...
	class PUNK_ENGINE_LOCAL Render : 
	...
	private:
		...
		*/
		...
		void OnMouseMove(const System::MouseEvent& event) {
			m_log->Debug("Render: " + event.ToString());
    ...
    PUNK_REGISTER_CREATOR(CLSID_Render, (System::CreateInstance<Render, IRender>));
}
PUNK_ENGINE_END
