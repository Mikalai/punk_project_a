...
//#endif	//	USE_OPENGL
//
//    class ScaledGridObject::ScaledGridObjectImpl : public ScaledGridObjectBase
//    {
//        using Base = ScaledGridObjectBase;
//
//        size_t m_total_width;
//        size_t m_total_height;
//
//    public:
//
//        ScaledGridObjectImpl(VideoDriver* driver) : Base(driver) {}
//
...
//    };
//
//    ScaledGridObject::ScaledGridObject(VideoDriver *driver)
//        : impl(new ScaledGridObjectImpl(driver))
//    {}
//
...
//    {
//        impl->Cook(width, height, hor_slices, vert_slices, levels);
//    }
//
//    float ScaledGridObject::GetTotalWidth() const
//    {
//        return impl->GetTotalWidth();
//    }
//
//    float ScaledGridObject::GetTotalHeight() const
//    {
//        return impl->GetTotalHeight();
//    }
//
//    void ScaledGridObject::Bind(int64_t value)
//    {
//        impl->Bind(value);
//    }
//
//    void ScaledGridObject::Unbind()
//    {
//        impl->Unbind();
//    }
//
