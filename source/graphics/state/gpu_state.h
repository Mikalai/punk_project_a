...
#include <graphics/fog/module.h>
#include <graphics/material/module.h>
#include <graphics/shadow/shadow_model.h>
...
namespace Graphics
{
    ...
    class PUNK_ENGINE_API ViewState final : private BaseState, public Core::Poolable<ViewState>
	{
	public:
		Math::mat4 m_projection;
		Math::mat4 m_view;
		Math::ClipSpace m_clip_space;
		Math::point3d m_camera_position;
        Math::point3d m_camera_view_position;
    ...
    class PUNK_ENGINE_API LightState final : private BaseState, public Core::Poolable<LightState>
	{
	public:        
        LightState();
    ...
    class PUNK_ENGINE_API RenderState final : private BaseState, public Core::Poolable<RenderState>
	{
	public:
		RenderState();
    ...
    class PUNK_ENGINE_API BatchState final : private BaseState, public Core::Poolable<BatchState>
	{
	public:        
    ...
    class PUNK_ENGINE_API TextureState final : private BaseState, public Core::Poolable<TextureState>
	{
	public:
		TextureState();
    ...
    class PUNK_ENGINE_API CoreState final : private BaseState, public Core::Poolable<CoreState>
	{
	public:		
        using BaseState::Inc;
        using BaseState::Dec;
		 ...
		 */
        ITexture2D* m_color_buffer;
        ITexture2D* m_depth_buffer;
