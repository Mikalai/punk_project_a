...
namespace Graphics
{
    namespace OpenGL {
		...
		private:
			...
			Core::Pointer<IRenderable> BuildVertexBufferPNC(
				const std::vector<Math::point4d>& position, 
				const std::vector<Math::vec4>& normal, 
				const std::vector<Math::vec4>& color)
			{
			...
			Core::Pointer<IRenderable> BuildVertexBufferP(const std::vector<Math::point4d>& position)
			{
			...
			Core::Pointer<IRenderable> BuildVertexBufferPC(
				const std::vector<Math::point4d>& position, 
				const std::vector<Math::vec4>& color)
			{
			...
			Core::Pointer<IRenderable> BuildVertexBufferPT(
				const std::vector<Math::point4d>& position, 
				const std::vector<Math::point4d>& texcoord)
			{
			...
			Core::Pointer<IRenderable> BuildVertexBufferPTC(
				const std::vector<Math::point4d>& position, 
				const std::vector<Math::point4d>& texcoord, 
				const std::vector<Math::vec4>& color)
			{
			...
			Core::Pointer<IRenderable> BuildVertexBufferPN(
				const std::vector<Math::point4d>& position, 
				const std::vector<Math::vec4>& normal)
			{
			...
			Core::Pointer<IRenderable> GlRenderableBuilder::BuildVertexBufferPNT0(
				const std::vector<Math::point4d>& position, 
				const std::vector<Math::vec4>& normal, 
				const std::vector<Math::point4d>& texcoord)
			{
       ...
       /* template<typename VertexType>
		...
		PUNK_REGISTER_CREATOR(CLSID_RenderableBuilder, (System::CreateInstance<GlRenderableBuilder, IRenderableBuilder>));
    }    	
}
PUNK_ENGINE_END
