#include "opengl/common/render_targets/module.h"
...
#include "gpu/common/video_driver_caps.h"
...
namespace Gpu
{
    namespace OpenGL
    {
        GlColorRenderBuffer::GlColorRenderBuffer(FrameBufferConfig *config, GlVideoDriverProxy *driver)
            : ColorRenderBuffer(driver->GetVideoDriver())
            , m_buffer(0)
        {
