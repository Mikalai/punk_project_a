...
{	
	...
	gl_Position = projectioncameramatrix * vec4(vertex_position, 1.0);
	ex_color.r = (1.0 - vertex_color.r);// * vertex_color.a;
	ex_color.g = (1.0 - vertex_color.g);// * vertex_color.a;
	ex_color.b = (1.0 - vertex_color.b);// * vertex_color.a;
	ex_color.a = vertex_color.a;
	
	ex_color.r *= entitymatrix[0][3] * vertex_color.a;
	ex_color.g *= entitymatrix[1][3] * vertex_color.a;
	ex_color.b *= entitymatrix[2][3] * vertex_color.a;
...
void main()
{
	fragData0 = ex_color * texture(texture0,texcoords0);
}
