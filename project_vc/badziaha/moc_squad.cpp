...
#include "../../source/badziaha/squad.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Squad_t, stringdata) + ofs \
...
const QMetaObject Squad::staticMetaObject = {
    { &Entity::staticMetaObject, qt_meta_stringdata_Squad.data,
      qt_meta_data_Squad,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Squad.stringdata))
