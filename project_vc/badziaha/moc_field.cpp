...
#include "../../source/badziaha/field.h"
...
QT_MOC_LITERAL(6, 53, 2)
    },
    "Field\0weatherChanged\0\0WeatherStamp\0"
    "value\0timeChanged\0dt"
};
...
void Field::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->weatherChanged((*reinterpret_cast< const WeatherStamp(*)>(_a[1]))); break;
        case 1: _t->timeChanged((*reinterpret_cast< const QDateTime(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Field::*_t)(const WeatherStamp & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Field::weatherChanged)) {
                *result = 0;
            }
        }
        {
            typedef void (Field::*_t)(const QDateTime & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Field::timeChanged)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void Field::weatherChanged(const WeatherStamp & _t1)
{
...
// SIGNAL 1
void Field::timeChanged(const QDateTime & _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
